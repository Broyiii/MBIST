...
module RF_DPHD_512x75 ( QA, RSCOUT, QB, ADRA, DA, WEA, MEA, CLKA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, TEST1A, TEST_RNMA, RMEA, RMA, LS, BC1, BC2, ADRB, DB, WEB, MEB, CLKB, TEST1B, TEST_RNMB, RMEB, RMB);
...
begin
  ...
  begin
    if( (MES_CNTRL =="ON" || MES_CNTRL == "WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING:RMA[3] is unknown>> at time=%t; instance=%m (RF_DPHD_512x75_core)",$realtime);
    end
  end
end
...
begin
  ...
  begin
    if( (MES_CNTRL =="ON" || MES_CNTRL == "WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING:RMB[3] is unknown>> at time=%t; instance=%m (RF_DPHD_512x75_core)",$realtime);
    end
  end
end
...
parameter words = 512, bits = 75, addrbits = 9, O_delay=0.0, timingmode = 1, rmbits=3;
...
reg mes_all_valid;
integer i;
reg [307:0] mem_core_array [0:127];
reg [74:0] mem_core_array_read [0:511];
...
begin : blk_readout_0
  ...
  begin : OUTPUT_a
    ...
    begin
      ...
      end // if of ADRAlatched <= 9'b111111111
...
begin : blk_intposclock_1
 ...
 `endif // endif of VIRAGE_FAST_VERILOG
  ...
  begin
    ...
    else if((ADRBlatched > 9'b111111111) && (MEBlatched === 1'b1) && (WEBlatched === 1'b1) )
    begin
      if( (MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid)
      begin
        $display("\n%m<<VIRL_MEM_WARNING:address is out of range>>(time %0t)\n RANGE: 0 to 511\n", $time);
...
begin : blk_readout_1
  ...
  begin : OUTPUT_b
    ...
    begin
      ...
      end // if of ADRBlatched <= 9'b111111111
