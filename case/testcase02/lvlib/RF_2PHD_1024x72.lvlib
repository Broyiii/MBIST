...
/*                      * Tessent MemoryBIST Model *                  */
   ...
   MemoryTemplate ( RF_2PHD_1024x72 ) {
   CellName:      RF_2PHD_1024x72;
   MemoryType:    SRAM;
   ...
   MinHold:  0.678;
   MilliWattsPerMegaHertz:  1.098e-02;
   ShadowRead: Off;
   WriteOutOfRange: Off;
...
RedundancyAnalysis { 
	ColumnSegment (Right) { 
		...
		FuseSet { 
			FuseMap[5:0] { 
				ShiftedIO(QB[36]):   6'b000000; 
				ShiftedIO(QB[37]):   6'b000001; 
				ShiftedIO(QB[38]):   6'b000010; 
				ShiftedIO(QB[39]):   6'b000011; 
				ShiftedIO(QB[40]):   6'b000100; 
				ShiftedIO(QB[41]):   6'b000101; 
				ShiftedIO(QB[42]):   6'b000110; 
				ShiftedIO(QB[43]):   6'b000111; 
				ShiftedIO(QB[44]):   6'b001000; 
				ShiftedIO(QB[45]):   6'b001001; 
				ShiftedIO(QB[46]):   6'b001010; 
				ShiftedIO(QB[47]):   6'b001011; 
				ShiftedIO(QB[48]):   6'b001100; 
				ShiftedIO(QB[49]):   6'b001101; 
				ShiftedIO(QB[50]):   6'b001110; 
				ShiftedIO(QB[51]):   6'b001111; 
				ShiftedIO(QB[52]):   6'b010000; 
				ShiftedIO(QB[53]):   6'b010001; 
				ShiftedIO(QB[54]):   6'b010010; 
				ShiftedIO(QB[55]):   6'b010011; 
				ShiftedIO(QB[56]):   6'b010100; 
				ShiftedIO(QB[57]):   6'b010101; 
				ShiftedIO(QB[58]):   6'b010110; 
				ShiftedIO(QB[59]):   6'b010111; 
				ShiftedIO(QB[60]):   6'b011000; 
				ShiftedIO(QB[61]):   6'b011001; 
				ShiftedIO(QB[62]):   6'b011010; 
				ShiftedIO(QB[63]):   6'b011011; 
				ShiftedIO(QB[64]):   6'b011100; 
				ShiftedIO(QB[65]):   6'b011101; 
				ShiftedIO(QB[66]):   6'b011110; 
				ShiftedIO(QB[67]):   6'b011111; 
				ShiftedIO(QB[68]):   6'b100000; 
				ShiftedIO(QB[69]):   6'b100001; 
				ShiftedIO(QB[70]):   6'b100010; 
