...
/*                      * Tessent MemoryBIST Model *                  */
   ...
   MemoryTemplate ( RF_2PHD_128x72 ) {
   CellName:      RF_2PHD_128x72;
   MemoryType:    SRAM;
   ...
   MinHold:  0.403;
   MilliWattsPerMegaHertz:  4.002e-03;
   ShadowRead: Off;
   WriteOutOfRange: Off;
...
RedundancyAnalysis { 
	ColumnSegment (Right) { 
		...
		FuseSet { 
			FuseMap[3:0] { 
				ShiftedIO(QB[36]):   4'b0000; 
				ShiftedIO(QB[37]):   4'b0000; 
				ShiftedIO(QB[38]):   4'b0000; 
				ShiftedIO(QB[39]):   4'b0000; 
				ShiftedIO(QB[40]):   4'b0001; 
				ShiftedIO(QB[41]):   4'b0001; 
				ShiftedIO(QB[42]):   4'b0001; 
				ShiftedIO(QB[43]):   4'b0001; 
				ShiftedIO(QB[44]):   4'b0010; 
				ShiftedIO(QB[45]):   4'b0010; 
				ShiftedIO(QB[46]):   4'b0010; 
				ShiftedIO(QB[47]):   4'b0010; 
				ShiftedIO(QB[48]):   4'b0011; 
				ShiftedIO(QB[49]):   4'b0011; 
				ShiftedIO(QB[50]):   4'b0011; 
				ShiftedIO(QB[51]):   4'b0011; 
				ShiftedIO(QB[52]):   4'b0100; 
				ShiftedIO(QB[53]):   4'b0100; 
				ShiftedIO(QB[54]):   4'b0100; 
				ShiftedIO(QB[55]):   4'b0100; 
				ShiftedIO(QB[56]):   4'b0101; 
				ShiftedIO(QB[57]):   4'b0101; 
				ShiftedIO(QB[58]):   4'b0101; 
				ShiftedIO(QB[59]):   4'b0101; 
				ShiftedIO(QB[60]):   4'b0110; 
				ShiftedIO(QB[61]):   4'b0110; 
				ShiftedIO(QB[62]):   4'b0110; 
				ShiftedIO(QB[63]):   4'b0110; 
				ShiftedIO(QB[64]):   4'b0111; 
				ShiftedIO(QB[65]):   4'b0111; 
				ShiftedIO(QB[66]):   4'b0111; 
				ShiftedIO(QB[67]):   4'b0111; 
				ShiftedIO(QB[68]):   4'b1000; 
				ShiftedIO(QB[69]):   4'b1000; 
				ShiftedIO(QB[70]):   4'b1000; 
				ShiftedIO(QB[71]):   4'b1000; 
			} 
		} 
		PinMap { 
			SpareElement { 
