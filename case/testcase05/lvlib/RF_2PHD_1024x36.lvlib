...
/*                      * Tessent MemoryBIST Model *                  */
   ...
   MemoryTemplate ( RF_2PHD_1024x36 ) {
   CellName:      RF_2PHD_1024x36;
   MemoryType:    SRAM;
   ...
   MinHold:  0.510;
   MilliWattsPerMegaHertz:  5.736e-03;
   ShadowRead: Off;
   WriteOutOfRange: Off;
...
RedundancyAnalysis { 
	ColumnSegment (Right) { 
		ShiftedIORange: QB[35:18]; 
                NumberOfSpareElements : 1; 
		FuseSet { 
			FuseMap[4:0] { 
				ShiftedIO(QB[18]):   5'b00000; 
				ShiftedIO(QB[19]):   5'b00001; 
				ShiftedIO(QB[20]):   5'b00010; 
				ShiftedIO(QB[21]):   5'b00011; 
				ShiftedIO(QB[22]):   5'b00100; 
				ShiftedIO(QB[23]):   5'b00101; 
				ShiftedIO(QB[24]):   5'b00110; 
				ShiftedIO(QB[25]):   5'b00111; 
				ShiftedIO(QB[26]):   5'b01000; 
				ShiftedIO(QB[27]):   5'b01001; 
				ShiftedIO(QB[28]):   5'b01010; 
				ShiftedIO(QB[29]):   5'b01011; 
				ShiftedIO(QB[30]):   5'b01100; 
				ShiftedIO(QB[31]):   5'b01101; 
				ShiftedIO(QB[32]):   5'b01110; 
				ShiftedIO(QB[33]):   5'b01111; 
				ShiftedIO(QB[34]):   5'b10000; 
