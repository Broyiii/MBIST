...
//                                                                    
//   Memory Name:RF_2PHD_64x128                                       
//   Memory Size:64 words x 128 bits                                  
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module RF_2PHD_64x128 ( RSCOUT, QB, ADRA, DA, WEA, MEA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, CLKA, TEST1A, RMEA, RMA, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
wire ADRA_valid;
assign ADRA_valid = ( ( ADRA_pre < 64 )?1'b1:1'b0);


wire ADRB_valid;
assign ADRB_valid = ( ( ADRB_pre < 64 )?1'b1:1'b0);
...
`ifdef VIRAGE_FAST_VERILOG
`else
assign notif_da = {notif_da_127, notif_da_126, notif_da_125, notif_da_124, notif_da_123, notif_da_122, notif_da_121, notif_da_120, notif_da_119, notif_da_118, notif_da_117, notif_da_116, notif_da_115, notif_da_114, notif_da_113, notif_da_112, notif_da_111, notif_da_110, notif_da_109, notif_da_108, notif_da_107, notif_da_106, notif_da_105, notif_da_104, notif_da_103, notif_da_102, notif_da_101, notif_da_100, notif_da_99, notif_da_98, notif_da_97, notif_da_96, notif_da_95, notif_da_94, notif_da_93, notif_da_92, notif_da_91, notif_da_90, notif_da_89, notif_da_88, notif_da_87, notif_da_86, notif_da_85, notif_da_84, notif_da_83, notif_da_82, notif_da_81, notif_da_80, notif_da_79, notif_da_78, notif_da_77, notif_da_76, notif_da_75, notif_da_74, notif_da_73, notif_da_72, notif_da_71, notif_da_70, notif_da_69, notif_da_68, notif_da_67, notif_da_66, notif_da_65, notif_da_64, notif_da_63, notif_da_62, notif_da_61, notif_da_60, notif_da_59, notif_da_58, notif_da_57, notif_da_56, notif_da_55, notif_da_54, notif_da_53, 
notif_da_52, notif_da_51, notif_da_50, notif_da_49, notif_da_48, notif_da_47, notif_da_46, notif_da_45, notif_da_44, notif_da_43, notif_da_42, notif_da_41, notif_da_40, notif_da_39, notif_da_38, notif_da_37, notif_da_36, notif_da_35, notif_da_34, notif_da_33, notif_da_32, notif_da_31, notif_da_30, notif_da_29, notif_da_28, notif_da_27, notif_da_26, notif_da_25, notif_da_24, notif_da_23, notif_da_22, notif_da_21, notif_da_20, notif_da_19, notif_da_18, notif_da_17, notif_da_16, notif_da_15, notif_da_14, notif_da_13, notif_da_12, notif_da_11, notif_da_10, notif_da_9, notif_da_8, notif_da_7, notif_da_6, notif_da_5, notif_da_4, notif_da_3, notif_da_2, notif_da_1, notif_da_0};
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x128_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x128_core)",$realtime);
    end
  end
end
...
parameter words = 64, bits = 128, addrbits = 6, timingmode = 1, rmbits=3;
...
wire RSCOUT_tmp;
reg mes_all_valid;
reg [135:0] mem_core_array [0:63];
reg [127:0] mem_core_array_read [0:63];
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          blk_right = ((bit_index - 64)/4) + (Y_adr/4);
  ...
  begin
    if (scan_reg[8] === 1'b1)
    begin
      if (scan_reg[3:0] === 4'b0)
      begin
      if ({scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1111)
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
        begin
        ...
        end // if of {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1111
        else
        begin
          blk_left = (bit_index/4) + (Y_adr/4);
          if (blk_left > {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]})
          begin
            column_position = (Y_adr + ((bit_index * 1) + 4));
          end // if of blk_left > {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]}
          else
          begin
            column_position = (Y_adr + (bit_index * 1));
          end // else of if blk_left > {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]}
        end // else of if {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1111
      end // if of unused scan register bits are zero
      else
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
...
begin
  ...
  begin
    ...
    get_column_position (col_address, 127);
    if (left_col_out_range !== 1'bx && right_col_out_range !== 1'bx)
    begin
//Left
      memrow[67:0] = tmp_memrow[67:0];
      if (!left_col_out_range)
      begin
        for (bit_cnt = 0; bit_cnt < 64; bit_cnt = bit_cnt +1)
        begin
...
//Right
      memrow[135:68] = tmp_memrow[135:68];
      if (!right_col_out_range)
      begin
        for (bit_cnt = 64; bit_cnt < 128; bit_cnt = bit_cnt +1)
        begin
          get_column_position (col_address, bit_cnt);
          memrow[col_address] = data[bit_cnt]; 
        end
...
begin
  ...
  begin
    ...
    begin
      for ( j = 0; j < 4 ; j = j +1 )
      begin
        column_to_corrupt = ((4*(faulty_blk_right+18)) + j);
...
begin
  X_adr = address;
   ...
   begin
     memdata[63:0] = {64{1'bx}};
   end
   get_column_position (col_address, 64);
   if ( right_col_out_range == 1'b0 )
   begin
     for (bit_cnt = 64; bit_cnt < 128; bit_cnt = bit_cnt +1)
     begin
...
task corrupt_all_loc;
 ...
 begin
  ...
  if( flag_range_ok == `True)
   begin
    for( row_index = 0; row_index < 64 ; row_index = row_index + 1)
    begin
      mem_core_array[row_index] = 136'bx;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ((start_adr_cnt + num_adr_cnt -1) > 63) begin
        $display("<<VIRL_MEM_WARNING>> \"init_mem_start_adr=%d + num_of_locations=%d\" exceed maximum address (NW-1)=63 instance=%m ",start_adr_cnt,num_adr_cnt);
      end
      if (^init_value === 1'bX)
      begin
      ...
      if (init_value === 128'b0 || init_value === 128'b1)
      begin
        for( adr_cnt = 0; adr_cnt < 64 ; adr_cnt = adr_cnt + 1)
        begin
          mem_array[adr_cnt] = {128{init_value[0]}};
        end
      end
      else
      begin
        ...
        begin
          ...
          begin
            mem_array[adr_cnt] = i;
            i = i + 1;
            if (i > 128'b11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111) i = 0;
          end
        end
      end
    end
...
genvar nk;
generate for (nk=0; nk<128; nk=nk+1)
begin : ENDA_blk
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRA is out of range>>, RANGE:0 to 63 time=%0t instance=%m\n",$time);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRB is out of range>>, RANGE:0 to 63 time=%0t instance=%m\n",$time);
