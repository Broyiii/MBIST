...
//                                                                    
//   Memory Name:RF_2PHD_64x72                                        
//   Memory Size:64 words x 72 bits                                   
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module RF_2PHD_64x72 ( RSCOUT, QB, ADRA, DA, WEA, MEA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, CLKA, TEST1A, RMEA, RMA, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
`ifdef VIRAGE_FAST_VERILOG
`else
assign notif_da = {notif_da_71, notif_da_70, notif_da_69, notif_da_68, notif_da_67, notif_da_66, notif_da_65, notif_da_64, notif_da_63, notif_da_62, notif_da_61, notif_da_60, notif_da_59, notif_da_58, notif_da_57, notif_da_56, notif_da_55, notif_da_54, notif_da_53, notif_da_52, notif_da_51, notif_da_50, notif_da_49, notif_da_48, notif_da_47, notif_da_46, notif_da_45, notif_da_44, notif_da_43, notif_da_42, notif_da_41, notif_da_40, notif_da_39, notif_da_38, notif_da_37, notif_da_36, notif_da_35, notif_da_34, notif_da_33, notif_da_32, notif_da_31, notif_da_30, notif_da_29, notif_da_28, notif_da_27, notif_da_26, notif_da_25, notif_da_24, notif_da_23, notif_da_22, notif_da_21, notif_da_20, notif_da_19, notif_da_18, notif_da_17, notif_da_16, notif_da_15, notif_da_14, notif_da_13, notif_da_12, notif_da_11, notif_da_10, notif_da_9, notif_da_8, notif_da_7, notif_da_6, notif_da_5, notif_da_4, notif_da_3, notif_da_2, notif_da_1, notif_da_0};
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x72_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x72_core)",$realtime);
    end
  end
end
...
parameter words = 64, bits = 72, addrbits = 6, timingmode = 1, rmbits=3;
...
wire RSCOUT_tmp;
reg mes_all_valid;
reg [79:0] mem_core_array [0:63];
reg [71:0] mem_core_array_read [0:63];
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if ({scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 4'b1000 )
        begin
          if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
          begin
        ...
        end // if of {scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 4'b1000
        else
        begin
          blk_right = ((bit_index - 36)/4) + (Y_adr/4);
        ...
        end // else of if {scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 4'b1000
  ...
  begin
    ...
    begin
      ...
      begin
      if ({scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1000)
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
        begin
        ...
        end // if of {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1000
        else
        begin
        ...
        end // else of if {scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 4'b1000
      end // if of unused scan register bits are zero
      else
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
...
begin
  ...
  begin
    ...
    get_column_position (col_address, 71);
    if (left_col_out_range !== 1'bx && right_col_out_range !== 1'bx)
    begin
//Left
      memrow[39:0] = tmp_memrow[39:0];
      if (!left_col_out_range)
      begin
        for (bit_cnt = 0; bit_cnt < 36; bit_cnt = bit_cnt +1)
        begin
...
//Right
      memrow[79:40] = tmp_memrow[79:40];
      if (!right_col_out_range)
      begin
        for (bit_cnt = 36; bit_cnt < 72; bit_cnt = bit_cnt +1)
        begin
          get_column_position (col_address, bit_cnt);
          memrow[col_address] = data[bit_cnt]; 
        end
...
begin
  ...
  begin
    ...
    begin
      for ( j = 0; j < 4 ; j = j +1 )
      begin
        column_to_corrupt = ((4*(faulty_blk_right+11)) + j);
...
begin
  X_adr = address;
   ...
   begin
     memdata[35:0] = {36{1'bx}};
   end
   get_column_position (col_address, 36);
   if ( right_col_out_range == 1'b0 )
   begin
     for (bit_cnt = 36; bit_cnt < 72; bit_cnt = bit_cnt +1)
     begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if (init_value === 72'b0 || init_value === 72'b1)
      begin
        for( adr_cnt = 0; adr_cnt < 64 ; adr_cnt = adr_cnt + 1)
        begin
          mem_array[adr_cnt] = {72{init_value[0]}};
        end
      end
      else
      begin
        ...
        begin
          ...
          begin
            mem_array[adr_cnt] = i;
            i = i + 1;
            if (i > 72'b111111111111111111111111111111111111111111111111111111111111111111111111) i = 0;
          end
        end
      end
    end
...
genvar nk;
generate for (nk=0; nk<72; nk=nk+1)
begin : ENDA_blk
