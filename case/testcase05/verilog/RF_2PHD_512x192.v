...
//                                                                    
//   Memory Name:RF_2PHD_512x192                                      
//   Memory Size:512 words x 192 bits                                 
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module RF_2PHD_512x192 ( RSCOUT, QB, ADRA, DA, WEA, MEA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, CLKA, TEST1A, RMEA, RMA, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
wire ADRA_valid;
assign ADRA_valid = ( ( ADRA_pre < 512 )?1'b1:1'b0);


wire ADRB_valid;
assign ADRB_valid = ( ( ADRB_pre < 512 )?1'b1:1'b0);
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (RF_2PHD_512x192_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (RF_2PHD_512x192_core)",$realtime);
    end
  end
end
...
parameter words = 512, bits = 192, addrbits = 9, timingmode = 1, rmbits=3;
...
wire RSCOUT_tmp;
reg mes_all_valid;
reg [391:0] mem_core_array [0:255];
reg [191:0] mem_core_array_read [0:511];
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if ({scan_reg[11],scan_reg[12],scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 6'b101111 )
        begin
          if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
          begin
        ...
        end // if of {scan_reg[11],scan_reg[12],scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 6'b101111
        else
        begin
          blk_right = (((bit_index - 96)/2) + (Y_adr/2));
        ...
        end // else of if {scan_reg[11],scan_reg[12],scan_reg[13],scan_reg[14],scan_reg[15],scan_reg[16]} > 6'b101111
  ...
  begin
    ...
    begin
      ...
      begin
      if ({scan_reg[2],scan_reg[3],scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 6'b101111)
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
        begin
        ...
        end // if of {scan_reg[2],scan_reg[3],scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 6'b101111
        else
        begin
        ...
        end // else of if {scan_reg[2],scan_reg[3],scan_reg[4],scan_reg[5],scan_reg[6],scan_reg[7]} > 6'b101111
      end // if of unused scan register bits are zero
      else
      begin
        if ((MES_CNTRL=="ON" || MES_CNTRL=="ERR") && $realtime != 0 && mes_all_valid)
...
begin
  ...
  begin
    ...
    get_column_position (col_address, Y_adr, 191);
    if (left_col_out_range !== 1'bx && right_col_out_range !== 1'bx)
    begin
//Left
      memrow[195:0] = tmp_memrow[195:0];
      ...
      begin
        memrow[195:0] = {196{1'bx}};
      end
//Right
      memrow[391:196] = tmp_memrow[391:196];
...
begin
  ...
  begin
    ...
    begin
      for ( j = 0; j < 4 ; j = j +1 )
      begin
        column_to_corrupt = ((4*(faulty_blk_right+50)) + j);
...
begin
  ...
  Y_adr = address[0];
   ...
   get_column_position (col_address, Y_adr, 96);
   if ( right_col_out_range == 1'b0 )
   begin
     for (bit_cnt = 96; bit_cnt < 192; bit_cnt = bit_cnt +1)
     begin
 ...
 begin
  ...
  if( flag_range_ok == `True)
   begin
    ...
    begin
      mem_core_array[row_index] = 392'bx;
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRA is out of range>>, RANGE:0 to 511 time=%0t instance=%m\n",$time);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRB is out of range>>, RANGE:0 to 511 time=%0t instance=%m\n",$time);
