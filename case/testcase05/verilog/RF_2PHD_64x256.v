...
//                                                                    
//   Memory Name:RF_2PHD_64x256                                       
//   Memory Size:64 words x 256 bits                                  
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module RF_2PHD_64x256 ( RSCOUT, QB, ADRA, DA, WEA, MEA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, CLKA, TEST1A, RMEA, RMA, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x256_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (RF_2PHD_64x256_core)",$realtime);
    end
  end
end
...
parameter words = 64, bits = 256, addrbits = 6, timingmode = 1, rmbits=3;
...
wire RSCOUT_tmp;
reg mes_all_valid;
reg [263:0] mem_core_array [0:63];
reg [255:0] mem_core_array_read [0:63];
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          blk_right = ((bit_index - 128)/4) + (Y_adr/4);
...
begin
  ...
  begin
    ...
    get_column_position (col_address, 255);
...
//Left
      ...
      begin
        for (bit_cnt = 0; bit_cnt < 128; bit_cnt = bit_cnt +1)
        begin
...
//Right
      ...
      begin
        for (bit_cnt = 128; bit_cnt < 256; bit_cnt = bit_cnt +1)
        begin
          get_column_position (col_address, bit_cnt);
          memrow[col_address] = data[bit_cnt]; 
        end
...
begin
  X_adr = address;
   ...
   begin
     memdata[127:0] = {128{1'bx}};
   end
   get_column_position (col_address, 128);
   if ( right_col_out_range == 1'b0 )
   begin
     for (bit_cnt = 128; bit_cnt < 256; bit_cnt = bit_cnt +1)
     begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if (init_value === 256'b0 || init_value === 256'b1)
      begin
        for( adr_cnt = 0; adr_cnt < 64 ; adr_cnt = adr_cnt + 1)
        begin
          mem_array[adr_cnt] = {256{init_value[0]}};
        end
      end
      else
      begin
        ...
        begin
          ...
          begin
            mem_array[adr_cnt] = i;
            i = i + 1;
            if (i > 256') i = 0;
          end
        end
      end
    end
