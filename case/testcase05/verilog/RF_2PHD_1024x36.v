...
//                                                                    
//   Memory Name:RF_2PHD_1024x36                                      
//   Memory Size:1024 words x 36 bits                                 
//                                                                    
//                               PORT NAME                            
//                               ---------                            
//               Output Ports                                         
...
module RF_2PHD_1024x36 ( RSCOUT, QB, ADRA, DA, WEA, MEA, RSCIN, RSCEN, RSCRST, RSCLK, FISO, CLKA, TEST1A, RMEA, RMA, LS, ADRB, MEB, CLKB, TEST1B, RMEB, RMB);
...
begin
  ...
  begin
    ...
    begin
      $display("<<VIRL_MEM_WARNING: RMA[3] is unknown>> at time=%t; instance=%m (RF_2PHD_1024x36_core)",$realtime);
    end
  end
end
always @(RMB_buf[3])
begin
  ...
  begin
    if( (MES_CNTRL=="ON"|| MES_CNTRL=="WARN") && $realtime != 0 && uut.mes_all_valid)
    begin
      $display("<<VIRL_MEM_WARNING: RMB[3] is unknown>> at time=%t; instance=%m (RF_2PHD_1024x36_core)",$realtime);
    end
  end
end
...
parameter words = 1024, bits = 36, addrbits = 10, timingmode = 1, rmbits=3;
...
reg [35:0] mem_core_array_read [0:1023];
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRA is out of range>>, RANGE:0 to 1023 time=%0t instance=%m\n",$time);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if(( MES_CNTRL=="ON" || MES_CNTRL=="WARN")&& $realtime != 0 && mes_all_valid == 1'b1)
            $display("<<VIRL_MEM_WARNING:address ADRB is out of range>>, RANGE:0 to 1023 time=%0t instance=%m\n",$time);
